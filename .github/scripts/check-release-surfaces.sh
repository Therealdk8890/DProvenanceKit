...
Match the status section independently of Unicode dash/spacing details,

while still requiring the exact current release link.

check_surface 
README.md 
“README status version” 
“**Public beta” 
“$release_version is released”
...
“.package(url: <span class="str">"$package_url", from:” 
“from: <span class="str">"$release_version")”
...
‘Public beta — 9.8.7 is released; APIs may evolve.’ > “$fixture/README.md”

printf ‘%s\n’ 
‘.package(url: “https://github.com/Therealdk8890/DProvenanceKit”, from: “9.8.7”)’ > “$fixture/COMMERCIAL.md”

printf ‘%s\n’ 
‘.package(url: “https://github.com/Therealdk8890/DProvenanceKit”, from: “9.8.7”)’ > “$fixture/site/index.html”
...
Prove that a stale site version is rejected.

printf ‘%s\n’ 
‘.package(url: “https://github.com/Therealdk8890/DProvenanceKit”, from: “9.8.6”)’ > “$fixture/site/index.html”
...
Prove that a stale library version constant is rejected.
...
Prove that the status check still requires the exact release link.

printf ‘%s\n’ 
‘dependencies: [.package(url: “https://github.com/Therealdk8890/DProvenanceKit”, from: “9.8.7”)]’ 
‘**Public beta - 9.8.6 is released.’ > “$fixture/README.md”
...
if check_surfaces “$fixture” >/dev/null 2>&1; then
echo “Self-test failed: a stale README status version was accepted.” >&2
return 1
fi
